 ...
 *
 * Inline em vez de fonte de icones ou arquivos soltos: aqui isso vale bytes de
 * verdade, porque quem assiste costuma abrir o link pelo celular, muitas vezes
 * em rede movel — e o primeiro carregamento e justamente o momento em que ele
 * esta com menos paciencia. Sem requisicao extra, sem flash de icone faltando.
 *
 * A cor sai de `currentColor`, entao um botao que fica vermelho leva o icone
 * junto sem CSS adicional.
 *
...
const PATHS: Record<IconName, ReactElement> = {
  ...
  fullscreen: <path d="M3.5 9V4.5a1 1 0 0 1 1-1H9M15 3.5h4.5a1 1 0 0 1 1 1V9M20.5 15v4.5a1 1 0 0 1-1 1H15M9 20.5H4.5a1 1 0 0 1-1-1V15" />,
  pip: (
    <>
  ...
  play: <path d="M6.5 4.3 19 12 6.5 19.7V4.3Z" />,
  pause: <path d="M9 4.5v15M15 4.5v15" />,
  refresh: (
    <>
      <path d="M20.5 12a8.5 8.5 0 1 1-2.6-6.1" />
      <path d="M20.5 3.5V10H14" />
    </>
  )
}
